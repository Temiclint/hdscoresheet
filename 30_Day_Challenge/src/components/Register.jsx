...
const newUniqueCode = `HD${uniqueCodeGenerator(
	6,
...
const Register = () => {
	...
	const uniqueCode = newUniqueCode;
	const upworkOut = 0;
	const socialPost = 0;
	const socialEngage = 0;
	const JobApp = 0;
	const localOut = 0;
	const intOut = 0;
	const ecommerce = 0;
	const NumOfClients = 0;
				...
				<div className="w-3/4 lg:w-1/3 m-auto">
					<form className="flex flex-col gap-y-4" onSubmit={handleSubmit}>
						...
						<div className="relative flex flex-col gap-1">
							<Label className=" ml-1" htmlFor="personalEmail">
								{" "}
								Email{" "}
							</Label>
							<Input
						...
						<div className="relative flex flex-col gap-1">
							<Label className=" ml-1" htmlFor="professionalEmail">
								{" "}
								Professional Email{" "}
							</Label>
							<Input
						...
						<div className="relative flex flex-col gap-1">
							<Label className=" ml-1" htmlFor="linkedin">
						...
						<div className="relative flex flex-col gap-1">
							<Label className="ml-1" htmlFor="jobApplication">
								Upwork Profile Link
							</Label>
							<Input
								type="text"
						...
						<div className="relative flex flex-col gap-1">
							<Label className=" ml-1" htmlFor="facebook">
								{" "}
						...
						<div className="relative flex flex-col gap-1">
							<Label className="ml-1" htmlFor="twitter">
								{" "}
						...
						<div className="relative flex flex-col gap-1">
							<Label className=" ml-1" htmlFor="funnel">
								{" "}
								Funnel Link{" "}
							</Label>
							<Input
						...
						{/* input for gohigh*/}
						<div className="relative flex flex-col gap-1">
							<Label className=" ml-1" htmlFor="gohigh">
								{" "}
								GoHighLevel Account Name
							</Label>
							<Input
								type="text"
								id="gohigh"
								placeholder="GoHighLevel Account Name"
								onChange={(e) => setGoHigh(e.target.value)}
								value={gohigh}
							/>
						</div>
